...
def free_process_route():
    ...
    # 🔥 IMPORTANT: redirect to your link FIRST
    # but token must be returned via YOUR server, not GPLinks
    return redirect(f"https://sfl.gl/vzr4cJ0B")
...
def free_return():
    ...
    # optional: mark used here OR sa generate endpoint
